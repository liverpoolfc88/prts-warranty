...
{{--                   salom--}}
{{--                    {!! Form::file('attachment', $pendingProblemAction->attachment,['required' => 'required'], ['class' => 'form-control','required' => 'required'], 'required') !!}--}}
...
{{--    @endif--}}
    ...
    @if($pendingProblemAction->stage->has_date)
        <div class="form-group {{ $errors->has('deadline_at') ? 'has-error' : ''}}">
            ...
            <div class="col-sm-8">
                {!! Form::text('deadline_at', $pendingProblemAction->deadline_at, ['class' => 'form-control datepicker']) !!}
            ...
            <div class="col-sm-8">
                @if($model->current_stage_id == 4)
                    <div  style="padding: 0px" class="col-sm-8">
                        <input name="attachment" required type="file" id="attachment">
                    </div>
                @else
                    <div class="col-sm-8">
